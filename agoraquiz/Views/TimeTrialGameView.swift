...
struct TimeTrialGameView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let gameData = GameResponse(
            game: Game(id: 1, score: 0, status: "in-progress", gameType: "time-trial", timeLeft: 60, questions: [Question(id: 1, questionText: "Sample question?", answers: ["Answer 1", "Answer 2", "Answer 3", "Answer 4"], correctAnswer: 1)]),
