...
from users.api.views import EmailRecoveryView, ActivateAccountView, CustomConfirmEmailView, RecoverySuccess, UserProfileView, RankingViewSet, UserUpdateView, UserDeleteView
...
urlpatterns = [
    ...
    path('users/delete/', UserDeleteView.as_view(), name='delete-account'),
